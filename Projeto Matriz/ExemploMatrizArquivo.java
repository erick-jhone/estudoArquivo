...
public class ExemploMatrizArquivo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String mat[][] = new String[sizeMatriz[0]][sizeMatriz[1]]; //crinado a matriz
        cParaMatriz(mat, meuArquivo); //copiar aquivo para matriz
        ordenar(mat);
        cParaArquivo(mat,meuArquivo); //copiar dados da matriz para o arquivo
    }
    ...
    public static void cParaArquivo(String mat[][], File arq)throws IOException{
        BufferedWriter fw = new BufferedWriter(new FileWriter(arq)); //abrindo o arquivo para escrever, se já existir sobrescreve
